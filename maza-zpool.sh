...
[Service]
ExecStart=/root/SRBMiner-Multi-2-4-7/SRBMiner-MULTI --disable-gpu --algorithm minotaurx --pool stratum+tcp://minotaurx.na.mine.zpool.ca:7019 --wallet MENenecQ8KEMdvLGqvYkr9sArDHZZmC8pJ --password c=MAZA,zap=MAZA
